...
<c:if test="${not empty bindedComponent && jcr:isNodeType(bindedComponent, 'alpitournt:tripCard, alpitournt:heading')}">
    <c:set var="targetProps" value="${bindedComponent.properties}"/>
</c:if>
<c:set var="tripTitle" value="${targetProps['tripTitle'].string}"/>
